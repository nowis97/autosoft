...
const executiveDashboardCode = `"use client";
...
fs.writeFileSync(path.join(__dirname, '..', 'src', 'components', 'analytics', 'ExecutiveDashboard.tsx'), executiveDashboardCode, 'utf8');
console.log('ExecutiveDashboard.tsx generated successfully!');
