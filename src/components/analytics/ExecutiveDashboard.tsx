  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 border-b border-slate-200 pb-4">
        <div className="inline-flex p-1 bg-slate-100 rounded-2xl border border-slate-200/80 shadow-xs self-start">
          <button
          ...
          <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200">
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition-all ${
                dateFilter === "1sem" ? "bg-white text-slate-900 shadow-2xs" : "text-slate-500 hover:text-slate-900"
              }`}
            >
              1 sem
            </button>
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition-all ${
                dateFilter === "mes" ? "bg-white text-slate-900 shadow-2xs" : "text-slate-500 hover:text-slate-900"
              }`}
            >
              Mes
            </button>
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition-all ${
                dateFilter === "ano" ? "bg-white text-slate-900 shadow-2xs" : "text-slate-500 hover:text-slate-900"
              }`}
            >
              Año
            </button>
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-semibold transition-all ${
                dateFilter === "todo" ? "bg-white text-slate-900 shadow-2xs" : "text-slate-500 hover:text-slate-900"
              }`}
            >
              Todo
            </button>
              ...
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-100 text-slate-400 font-bold uppercase tracking-wider text-[11px]">
                    <th className="py-3 px-3 whitespace-nowrap">Vehículo</th>
                    <th className="py-3 px-3 whitespace-nowrap">Transacción</th>
                    <th className="py-3 px-3 whitespace-nowrap">Email Cliente</th>
                    <th className="py-3 px-3 whitespace-nowrap">Tipo Adquisición</th>
                    <th className="py-3 px-3 whitespace-nowrap">Vendedor</th>
                    <th className="py-3 px-3 whitespace-nowrap text-right">Precio Acordado</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  {vehicles.slice(0, 5).map((v) => (
                    <tr key={v.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-3 whitespace-nowrap font-medium text-slate-600">cliente@correo.cl</td>
