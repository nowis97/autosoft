    ...
    if (db) {
      try {
        await db.insert(vehiclesTable).values({
          ...
          vin: created.vin || null,
          priceCash: created.priceCash,
          priceFinanced: created.priceFinanced || null,
          acquisitionCost: created.acquisitionCost || null,
          status: created.status as any,
          description: created.description || "",
          features: created.features || [],
          images: created.images || [],
          publishedToWeb: created.publishedToWeb ?? true,
          publishedToMercadolibre: created.publishedToMercadolibre ?? true,
          publishedToChileautos: created.publishedToChileautos ?? true,
          publishedToYapo: created.publishedToYapo ?? true,
